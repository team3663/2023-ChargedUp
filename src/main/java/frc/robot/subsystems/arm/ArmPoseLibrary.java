...
public class ArmPoseLibrary {
    ...
    static {
        ...
        conePoses.put(ArmPoseID.DOUBLE_STATION_PICKUP, new Pose2d(0.02, 0.96, Rotation2d.fromDegrees(30.0)));
        ...
        genericPoses.put(ArmPoseID.PLACE_INTERMEDIATE, new Pose2d(0.226, 0.920, Rotation2d.fromDegrees(90.0)));
