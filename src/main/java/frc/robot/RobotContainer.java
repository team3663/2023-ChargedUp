...
public class RobotContainer {
    ...
    private void setupAutoChooser() {
        ...
        autoChooser.registerCreator("Balance 1", () -> AutoCommandFactory.createMidBalanceAuto());
        autoChooser.registerCreator("Balance-Mobility 1", () -> AutoCommandFactory.createMidMobilityBalanceAuto());
        ...
        autoChooser.registerCreator("3Place-Red", () -> AutoCommandFactory.getRed3Auto());
        autoChooser.registerCreator("2Place-Red", () -> AutoCommandFactory.getRed2Auto());
        autoChooser.registerCreator("BumpSide 2 Red", () -> AutoCommandFactory.createBumpSideRedAuto());
