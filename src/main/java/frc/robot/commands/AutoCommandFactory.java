...
public final class AutoCommandFactory {
    ...
    private static SequentialCommandGroup red2Command;
    ...
    public static SequentialCommandGroup createBumpSideRedAuto() {
        ...
        // Go to and pickup the cube
        List<PathPlannerTrajectory> pathGroup = PathPlanner.loadPathGroup("Bump-2-Red", normalConstraints, intakeConstraints);
        cmd = builder.fullAuto(pathGroup.get(0));
        group.addCommands(cmd);
        cmd = builder.fullAuto(pathGroup.get(1));
        group.addCommands(new ParallelRaceGroup(cmd, new IntakeGamePieceCommand(intake, 10000)));
        ...
        // Return to community and score
        cmd = builder.fullAuto(PathPlanner.loadPath("Bump-Return-Red", normalConstraints));
        group.addCommands(cmd);
    ...
    public static SequentialCommandGroup createRed2Auto() {
        ...
        // Return to community
        cmd = builder.fullAuto(PathPlanner.loadPath("SillyPath", normalConstraints));
        group.addCommands(cmd);
    ...
    public static SequentialCommandGroup getRed2Auto() {
        return red2Command;
    }
